...
class QueryPlanner:
    def plan_query(self, prompt: str, user_preset_id: str = None) -> Dict[str, Any]:
        ...
        GLOBAL_GEO_INDEX = {
            ...
            # Indian Regional & Village Indexes
        ...
        if matched_loc:
        ...
        elif user_preset_id and user_preset_id in settings.PRESETS:
            ...
            is_indian = bool(re.search(r'india|village|gaon|tehsil|district|patti|basti|taluka|gram|pradesh|state', prompt_lower))
